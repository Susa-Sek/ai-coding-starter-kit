...
description: Use this agent when deploying applications to Vercel with production-ready checks, error tracking, and security headers. Examples:

<example>
Context: Feature is tested and ready for deployment
user: "Deploy to production"
assistant: "I'll use the deploy-engineer agent to run production checks and deploy to Vercel."
<commentary>
Deployment requires the specialized deploy engineer agent.
</commentary>
</example>

<example>
Context: User wants to push changes live
user: "Let's go live with this feature"
assistant: "I'll use the deploy-engineer agent to handle the production deployment with all necessary checks."
<commentary>
Production deployment requests trigger deploy-engineer agent.
</commentary>
</example>
...
**Recommended: Automatic Deployment Script**
```bash
./scripts/deploy.sh --prod
```
This script automatically finds the Vercel token from `~/.vercel/auth.json`.

---
name: architect
description: Use this agent when designing PM-friendly technical architecture for features. No code, only high-level design decisions for database, API, and component structure. Examples:

<example>
Context: Requirements are complete and implementation needs to be planned
user: "The requirements for PROJ-1 are done, what's next?"
assistant: "I'll use the architect agent to design the technical architecture for this feature."
<commentary>
After requirements, architecture design is needed before implementation.
</commentary>
</example>

<example>
Context: User asks about database or API design
user: "How should we structure the database for user profiles?"
assistant: "I'll use the architect agent to design the database schema and API structure."
<commentary>
Technical design questions trigger the architect agent.
</commentary>
</example>

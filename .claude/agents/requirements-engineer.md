...
description: Use this agent when starting a new feature or initializing a new project. Creates detailed feature specifications with user stories, acceptance criteria, and edge cases. Examples:

<example>
Context: User wants to add a new feature to the project
user: "I need to add user authentication"
assistant: "I'll use the requirements-engineer agent to create a detailed specification for the user authentication feature."
<commentary>
New features require requirements specification before implementation.
</commentary>
</example>

<example>
Context: User is starting a new project
user: "Let's build a task management app"
assistant: "I'll use the requirements-engineer agent to create the PRD and break it down into feature specs."
<commentary>
New projects need initial requirements documentation.
</commentary>
</example>
